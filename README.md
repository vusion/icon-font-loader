...
Import svg files by using a virtual property `icon-font` in CSS. And generate icon fonts after collecting all svgs. This loader can be seen as an equivalent substitution from characters to font icons.
